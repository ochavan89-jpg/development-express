...
const getJwtSecret = () => process.env.JWT_SECRET || JWT_FALLBACK_SECRET
...
const protect = async (req, res, next) => {
  try {
    ...
    // Demo fallback is intentionally disabled in production so DB outages fail closed.
    try {
...
module.exports = { protect, authorize, getJwtSecret, allowDemoFallback }
