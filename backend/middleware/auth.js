...
const jwtSecret = () => process.env.JWT_SECRET || (process.env.NODE_ENV === 'production' ? null : 'devexpress_fallback_secret')
...
const protect = async (req, res, next) => {
  try {
    ...
    // Demo fallback is only for local/demo runs; production must not fail open on DB errors.
    try {
